...
public class Solution20Pt1() : SolutionFramework(20)
{
    ...
    public override string[] Solve()
    {
        ...
        for (var i = 0; i < 1000; i++)
        {
            ...
            //Push button
            var broadcastModule = modulesState["broadcaster"];
            broadcastModule.LastReceivedPulse = Pulse.Low;
            lowPN++;
        
            var processingQ = new Queue<(string ModuleName, Module module)>();
            processingQ.Enqueue(("broadcaster", broadcastModule));
